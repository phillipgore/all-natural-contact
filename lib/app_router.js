...
var requireLogin = function() {
	if (!Meteor.userId()) {
		...
		var stripeSubcription = Groups.findOne().stripeSubcription;
		...
		if (!stripeSubcription && free_account_expires <= current_date && Meteor.user().role.app_administrator === false && Controls.findOne().publicBeta === false) {
...
Router.onAfterAction(searchClear, {except: ['contactsSearch', 'contactInfo', 'exportLoading']});
